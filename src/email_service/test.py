...
def main():
	...
	try:
		print(f"Sending -> from: {es.email_id}  to: dheeraj.cuboulder@gmail.com  subject: {subject}")
		es.send_to_custom_recipient(target_email="dheeraj.cuboulder@gmail.com", subject=subject, content=content)
		print("Send attempted — if SMTP credentials are correct, the recipient should receive the message.")
	except Exception as e:
		print("Error while sending email:", repr(e))
